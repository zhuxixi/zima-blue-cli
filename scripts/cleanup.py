...
Examples:
  ...
  python scripts/cleanup.py --all        # Also clean log files
    ...
    parser.add_argument("--auto", "-a", action="store_true", help="Auto mode, no confirmation")
    parser.add_argument(
        "--dry-run", "-n", action="store_true", help="Only show what would be cleaned"
    )
    parser.add_argument("--all", "-A", action="store_true", help="Clean all including log files")
    parser.add_argument(
        "--temp-only", "-t", action="store_true", help="Only clean system temp directories"
    )
    parser.add_argument(
        "--cache-only", "-c", action="store_true", help="Only clean project cache files"
    )
