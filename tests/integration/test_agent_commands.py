...
class TestAgentCreate(TestIsolator):
    ...
    def test_create_duplicate_code(self):
        ...
        # Create first agent
        runner.invoke(app, ["agent", "create", "--name", "First Agent", "--code", "duplicate-test"])

        # Try to create second with same code
        result = runner.invoke(
            app, ["agent", "create", "--name", "Second Agent", "--code", "duplicate-test"]
        )
    ...
    def test_create_invalid_code_format(self):
        ...
        result = runner.invoke(app, ["agent", "create", "--name", "Test", "--code", "Invalid_Code"])
    ...
    def test_create_from_existing(self):
        ...
        # Create source agent
        runner.invoke(app, ["agent", "create", "--name", "Source Agent", "--code", "source-agent"])
    ...
    def test_create_from_nonexistent(self):
        ...
        result = runner.invoke(
            app, ["agent", "create", "--name", "Test", "--code", "test", "--from", "nonexistent"]
        )
...
class TestAgentList(TestIsolator):
    ...
    def test_list_filter_by_type(self):
        ...
        runner.invoke(
            app, ["agent", "create", "--name", "Claude", "--code", "c1", "--type", "claude"]
        )
...
class TestAgentUpdate(TestIsolator):
    ...
    def test_update_name(self):
        ...
        result = runner.invoke(app, ["agent", "update", "update-test", "--name", "New Name"])
