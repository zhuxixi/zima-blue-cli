...
class TestWorkflowCreate(TestIsolator):
    ...
    def test_create_basic(self):
        ...
        result = runner.invoke(
            app, ["workflow", "create", "--code", "test-workflow", "--name", "Test Workflow"]
        )
    ...
    def test_create_duplicate_code_fails(self):
        ...
        # Create first
        runner.invoke(app, ["workflow", "create", "--code", "duplicate-wf", "--name", "First"])

        # Try to create second with same code
        result = runner.invoke(
            app, ["workflow", "create", "--code", "duplicate-wf", "--name", "Second"]
        )
    ...
    def test_create_invalid_code_fails(self):
        ...
        result = runner.invoke(
            app, ["workflow", "create", "--code", "Invalid_Code", "--name", "Test"]
        )
    ...
    def test_create_invalid_format_fails(self):
        ...
        result = runner.invoke(
            app, ["workflow", "create", "--code", "test", "--name", "Test", "--format", "invalid"]
        )
    ...
    def test_create_from_nonexistent_fails(self):
        ...
        result = runner.invoke(
            app,
            ["workflow", "create", "--code", "new-wf", "--name", "New", "--from", "nonexistent"],
        )
...
class TestWorkflowList(TestIsolator):
    ...
    def test_list_with_workflows(self):
        ...
        for i in range(3):
            runner.invoke(
                app, ["workflow", "create", "--code", f"wf-{i}", "--name", f"Workflow {i}"]
            )
    ...
    def test_list_filter_by_tag(self):
        ...
        runner.invoke(app, ["workflow", "create", "--code", "tagged-wf", "--name", "Tagged"])
        runner.invoke(app, ["workflow", "update", "tagged-wf", "--add-tag", "test-tag"])

        runner.invoke(app, ["workflow", "create", "--code", "untagged-wf", "--name", "Untagged"])
...
class TestWorkflowShow(TestIsolator):
    ...
    def test_show_json_format(self):
        ...
        runner.invoke(app, ["workflow", "create", "--code", "json-test", "--name", "JSON Test"])

        result = runner.invoke(app, ["workflow", "show", "json-test", "--format", "json"])
...
class TestWorkflowUpdate(TestIsolator):
    ...
    def test_update_name(self):
        ...
        runner.invoke(
            app, ["workflow", "create", "--code", "update-test", "--name", "Original Name"]
        )

        result = runner.invoke(app, ["workflow", "update", "update-test", "--name", "Updated Name"])
    ...
    def test_update_add_tags(self):
        """Test adding tags."""
        runner.invoke(app, ["workflow", "create", "--code", "tag-test", "--name", "Tag Test"])

        result = runner.invoke(
            app, ["workflow", "update", "tag-test", "--add-tag", "tag1", "--add-tag", "tag2"]
        )
    ...
    def test_update_no_changes(self):
        ...
        runner.invoke(app, ["workflow", "create", "--code", "no-change", "--name", "No Change"])
...
class TestWorkflowDelete(TestIsolator):
    ...
    def test_delete_existing(self):
        ...
        runner.invoke(app, ["workflow", "create", "--code", "delete-test", "--name", "Delete Test"])

        result = runner.invoke(app, ["workflow", "delete", "delete-test", "--force"])
...
class TestWorkflowValidate(TestIsolator):
    ...
    def test_validate_valid(self):
        ...
        runner.invoke(app, ["workflow", "create", "--code", "valid-wf", "--name", "Valid Workflow"])
...
class TestWorkflowRender(TestIsolator):
    ...
    def test_render_simple(self):
        ...
        result = runner.invoke(app, ["workflow", "render", "render-test", "--var", "name=World"])
    ...
    def test_render_with_variable_config(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "my-vars", "--name", "My Variables"])
        runner.invoke(
            app, ["variable", "set", "my-vars", "--key", "task.name", "--value", "Test Task"]
        )

        # Render
        result = runner.invoke(app, ["workflow", "render", "wf-with-vars", "--variable", "my-vars"])
    ...
    def test_render_validation_failure(self):
        ...
        result = runner.invoke(app, ["workflow", "render", "validate-render"])
...
class TestWorkflowAddVar(TestIsolator):
    ...
    def test_add_variable(self):
        ...
        runner.invoke(
            app, ["workflow", "create", "--code", "add-var-test", "--name", "Add Var Test"]
        )
...
class TestWorkflowLifecycle(TestIsolator):
    ...
    def test_full_lifecycle(self):
        ...
        # Render
        result = runner.invoke(app, ["workflow", "render", "lifecycle-wf", "--var", "name=World"])
        assert result.exit_code == 0
        assert "Hello World!" in strip_ansi(result.output)

        # Update
        result = runner.invoke(
            app, ["workflow", "update", "lifecycle-wf", "--name", "Updated Lifecycle"]
        )
        assert result.exit_code == 0

        # Delete
        result = runner.invoke(app, ["workflow", "delete", "lifecycle-wf", "--force"])
        assert result.exit_code == 0
