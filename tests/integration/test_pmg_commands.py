...
class TestPMGCreate(TestIsolator):
    ...
    def test_create_basic(self):
        ...
        result = runner.invoke(
            app, ["pmg", "create", "--code", "test-pmg", "--name", "Test PMG", "--for-type", "kimi"]
        )
    ...
    def test_create_duplicate_code_fails(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "duplicate-pmg", "--name", "First", "--for-type", "kimi"],
        )

        result = runner.invoke(
            app,
            ["pmg", "create", "--code", "duplicate-pmg", "--name", "Second", "--for-type", "kimi"],
        )
    ...
    def test_create_invalid_code_fails(self):
        ...
        result = runner.invoke(
            app, ["pmg", "create", "--code", "Invalid_Code", "--name", "Test", "--for-type", "kimi"]
        )
    ...
    def test_create_invalid_type_fails(self):
        ...
        result = runner.invoke(
            app, ["pmg", "create", "--code", "test", "--name", "Test", "--for-type", "invalid"]
        )
    ...
    def test_create_from_existing(self):
        ...
        runner.invoke(
            app, ["pmg", "create", "--code", "source-pmg", "--name", "Source", "--for-type", "kimi"]
        )
...
class TestPMGList(TestIsolator):
    ...
    def test_list_with_pmgs(self):
        ...
        for i in range(3):
            runner.invoke(
                app,
                ["pmg", "create", "--code", f"pmg-{i}", "--name", f"PMG {i}", "--for-type", "kimi"],
            )
    ...
    def test_list_filter_by_type(self):
        ...
        runner.invoke(
            app, ["pmg", "create", "--code", "kimi-pmg", "--name", "Kimi PMG", "--for-type", "kimi"]
        )
...
class TestPMGShow(TestIsolator):
    ...
    def test_show_existing(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "show-test", "--name", "Show Test", "--for-type", "kimi"],
        )
    ...
    def test_show_json_format(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "json-pmg", "--name", "JSON Test", "--for-type", "kimi"],
        )

        result = runner.invoke(app, ["pmg", "show", "json-pmg", "--format", "json"])
...
class TestPMGUpdate(TestIsolator):
    ...
    def test_update_name(self):
        ...
        result = runner.invoke(app, ["pmg", "update", "update-test", "--name", "Updated Name"])
    ...
    def test_update_raw(self):
        ...
        runner.invoke(
            app, ["pmg", "create", "--code", "raw-test", "--name", "Raw Test", "--for-type", "kimi"]
        )

        result = runner.invoke(app, ["pmg", "update", "raw-test", "--raw", "--experimental"])
    ...
    def test_update_no_changes(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "no-change", "--name", "No Change", "--for-type", "kimi"],
        )
...
class TestPMGDelete(TestIsolator):
    ...
    def test_delete_existing(self):
        ...
        result = runner.invoke(app, ["pmg", "delete", "delete-test", "--force"])
    ...
    def test_delete_nonexistent(self):
        ...
        result = runner.invoke(app, ["pmg", "delete", "nonexistent", "--force"])
...
class TestPMGValidate(TestIsolator):
    ...
    def test_validate_valid(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "valid-pmg", "--name", "Valid PMG", "--for-type", "kimi"],
        )
...
class TestPMGAddParam(TestIsolator):
    ...
    def test_add_flag_param(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "flag-test", "--name", "Flag Test", "--for-type", "kimi"],
        )

        result = runner.invoke(
            app,
            ["pmg", "add-param", "flag-test", "--name", "verbose", "--type", "flag", "--enabled"],
        )
...
class TestPMGRemoveParam(TestIsolator):
    ...
    def test_remove_existing(self):
        ...
        result = runner.invoke(app, ["pmg", "remove-param", "remove-test", "--name", "to-remove"])
    ...
    def test_remove_nonexistent(self):
        ...
        result = runner.invoke(app, ["pmg", "remove-param", "remove-none", "--name", "nonexistent"])
...
class TestPMGBuild(TestIsolator):
    ...
    def test_build_list_format(self):
        ...
        runner.invoke(
            app,
            ["pmg", "create", "--code", "build-test", "--name", "Build Test", "--for-type", "kimi"],
        )
        runner.invoke(
            app,
            [
        ...
        result = runner.invoke(app, ["pmg", "build", "build-test", "--format", "list"])
    ...
    def test_build_shell_format(self):
        ...
        runner.invoke(
            app,
            ["pmg", "add-param", "build-shell", "--name", "verbose", "--type", "flag", "--enabled"],
        )

        result = runner.invoke(app, ["pmg", "build", "build-shell", "--format", "shell"])
...
class TestPMGLifecycle(TestIsolator):
    ...
    def test_full_lifecycle(self):
        ...
        # Build
        result = runner.invoke(app, ["pmg", "build", "lifecycle-pmg", "--format", "shell"])
        assert result.exit_code == 0
        assert "--model" in result.output
        assert "--verbose" in result.output
        ...
        # Update
        result = runner.invoke(
            app, ["pmg", "update", "lifecycle-pmg", "--name", "Updated Lifecycle"]
        )
        assert result.exit_code == 0

        # Remove parameter
        result = runner.invoke(app, ["pmg", "remove-param", "lifecycle-pmg", "--name", "verbose"])
        assert result.exit_code == 0

        # Delete
        result = runner.invoke(app, ["pmg", "delete", "lifecycle-pmg", "--force"])
        assert result.exit_code == 0
