...
class TestVariableCreate(TestIsolator):
    ...
    def test_create_basic(self):
        ...
        result = runner.invoke(
            app, ["variable", "create", "--code", "test-vars", "--name", "Test Variables"]
        )
    ...
    def test_create_with_workflow(self):
        ...
        runner.invoke(
            app, ["workflow", "create", "--code", "target-wf", "--name", "Target Workflow"]
        )
    ...
    def test_create_duplicate_code_fails(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "duplicate-var", "--name", "First"])

        result = runner.invoke(
            app, ["variable", "create", "--code", "duplicate-var", "--name", "Second"]
        )
    ...
    def test_create_from_existing(self):
        ...
        # Create source
        runner.invoke(app, ["variable", "create", "--code", "source-var", "--name", "Source Var"])
        runner.invoke(app, ["variable", "set", "source-var", "--key", "key1", "--value", "value1"])
...
class TestVariableList(TestIsolator):
    ...
    def test_list_with_variables(self):
        ...
        for i in range(3):
            runner.invoke(
                app, ["variable", "create", "--code", f"vars-{i}", "--name", f"Variables {i}"]
            )
    ...
    def test_list_filter_by_workflow(self):
        ...
        # Create workflow
        runner.invoke(app, ["workflow", "create", "--code", "filter-wf", "--name", "Filter WF"])
        ...
        runner.invoke(app, ["variable", "create", "--code", "generic", "--name", "Generic"])

        result = runner.invoke(app, ["variable", "list", "--for-workflow", "filter-wf"])
...
class TestVariableShow(TestIsolator):
    ...
    def test_show_existing(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "show-var", "--name", "Show Variable"])
...
class TestVariableUpdate(TestIsolator):
    ...
    def test_update_name(self):
        ...
        runner.invoke(
            app, ["variable", "create", "--code", "update-var", "--name", "Original Name"]
        )

        result = runner.invoke(app, ["variable", "update", "update-var", "--name", "Updated Name"])
    ...
    def test_update_workflow(self):
        ...
        # Create workflow
        runner.invoke(app, ["workflow", "create", "--code", "new-wf", "--name", "New Workflow"])

        runner.invoke(app, ["variable", "create", "--code", "wf-update", "--name", "WF Update"])

        result = runner.invoke(app, ["variable", "update", "wf-update", "--for-workflow", "new-wf"])
...
class TestVariableDelete(TestIsolator):
    ...
    def test_delete_existing(self):
        ...
        runner.invoke(
            app, ["variable", "create", "--code", "delete-var", "--name", "Delete Variable"]
        )

        result = runner.invoke(app, ["variable", "delete", "delete-var", "--force"])
...
class TestVariableSet(TestIsolator):
    ...
    def test_set_simple_value(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "set-test", "--name", "Set Test"])

        result = runner.invoke(
            app, ["variable", "set", "set-test", "--key", "simple_key", "--value", "simple_value"]
        )
    ...
    def test_set_nested_value(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "nested-set", "--name", "Nested Set"])

        result = runner.invoke(
            app, ["variable", "set", "nested-set", "--key", "task.name", "--value", "Task Name"]
        )
    ...
    def test_set_json_value(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "json-set", "--name", "JSON Set"])
        ...
        # Verify with get
        result = runner.invoke(app, ["variable", "get", "json-set", "config"])
...
class TestVariableGet(TestIsolator):
    ...
    def test_get_simple_value(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "get-test", "--name", "Get Test"])
        runner.invoke(
            app, ["variable", "set", "get-test", "--key", "my_key", "--value", "my_value"]
        )

        result = runner.invoke(app, ["variable", "get", "get-test", "my_key"])
    ...
    def test_get_nested_value(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "nested-get", "--name", "Nested Get"])
        runner.invoke(
            app, ["variable", "set", "nested-get", "--key", "task.config.timeout", "--value", "60"]
        )

        result = runner.invoke(app, ["variable", "get", "nested-get", "task.config.timeout"])
    ...
    def test_get_nonexistent(self):
        ...
        runner.invoke(app, ["variable", "create", "--code", "missing-key", "--name", "Missing Key"])

        result = runner.invoke(app, ["variable", "get", "missing-key", "nonexistent"])
...
class TestVariableValidate(TestIsolator):
    ...
    def test_validate_valid(self):
        ...
        runner.invoke(
            app, ["variable", "create", "--code", "valid-var", "--name", "Valid Variable"]
        )
...
class TestVariableMerge(TestIsolator):
    ...
    def test_merge_values(self):
        ...
        # Create source
        runner.invoke(
            app, ["variable", "create", "--code", "merge-source", "--name", "Merge Source"]
        )
        runner.invoke(
            app,
            ["variable", "set", "merge-source", "--key", "shared_key", "--value", "source_value"],
        )
        runner.invoke(
            app,
            [
        ...
        # Create target
        runner.invoke(
            app, ["variable", "create", "--code", "merge-target", "--name", "Merge Target"]
        )
        runner.invoke(
            app,
            ["variable", "set", "merge-target", "--key", "shared_key", "--value", "target_value"],
        )
        runner.invoke(
            app,
            [
        ...
        # Merge
        result = runner.invoke(app, ["variable", "merge", "merge-target", "--from", "merge-source"])
    ...
    def test_variable_workflow_integration(self):
        ...
        runner.invoke(
            ...
            [
                ...
                "Integrated Workflow",
                "--template",
                "Task: {{ task.name }}, Steps: {{ task.steps | join(', ') }}",
            ],
        )
        runner.invoke(
            app,
        ...
        result = runner.invoke(
            app, ["workflow", "render", "integrated-wf", "--variable", "integrated-vars"]
        )
