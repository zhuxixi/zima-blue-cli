...
class TestEnvSet(TestIsolator):
    ...
    def test_set_secret_env_source(self, monkeypatch):
        ...
        runner.invoke(app, [
            "env", "create",
            "--code", "secret-env-test",
            "--name", "Secret Env Test",
            "--for-type", "kimi"
        ])
        
        result = runner.invoke(app, [
            "env", "set", "secret-env-test",
            "--key", "API_KEY",
            "--secret",
            "--source", "env",
    ...
    def test_set_secret_file_source(self, tmp_path):
        ...
        runner.invoke(app, [
            "env", "create",
            "--code", "secret-file-test",
            "--name", "Secret File Test",
            "--for-type", "kimi"
        ])
        
        result = runner.invoke(app, [
            "env", "set", "secret-file-test",
            "--key", "API_KEY",
            "--secret",
            "--source", "file",
...
class TestEnvGet(TestIsolator):
    ...
    def test_get_secret_masked(self):
        ...
        runner.invoke(app, [
            ...
            "--secret",
            "--source", "env",
            "--value", "SRC"  # Use --value as source-key for env
        ])
    ...
    def test_get_secret_resolved(self, monkeypatch):
        ...
        runner.invoke(app, [
            "env", "set", "get-resolved",
            "--key", "API_KEY",
            "--secret",
            "--source", "env",
            "--value", "RESOLVE_SRC"  # Use --value as source-key
        ])
        
        result = runner.invoke(app, [
            "env", "get", "get-resolved",
            "--key", "API_KEY",
            "--resolve"
        ])
...
class TestEnvExport(TestIsolator):
    ...
    def test_export_shell(self):
        ...
        runner.invoke(app, [
            "env", "set", "export-shell",
            "--key", "KEY1",
            "--value", "value1"
        ])
        
        result = runner.invoke(app, [
            "env", "export", "export-shell",
            "--format", "shell"
        ])
    ...
    def test_export_resolve_secrets(self, monkeypatch):
        ...
        runner.invoke(app, [
            "env", "set", "export-secret",
            "--key", "SECRET_KEY",
            "--secret",
            "--source", "env",
            "--value", "SECRET_SRC"  # Use --value as source-key
        ])
        
        result = runner.invoke(app, [
            "env", "export", "export-secret",
            "--format", "dotenv",
            "--resolve-secrets"
        ])
...
class TestEnvLifecycle(TestIsolator):
    ...
    def test_full_lifecycle(self, monkeypatch):
        ...
        # Delete
        result = runner.invoke(app, [
            "env", "delete", "lifecycle-env", "--force"
        ])
        assert result.exit_code == 0
