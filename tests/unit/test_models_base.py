...
class TestMetadata:
    ...
    def test_to_dict(self):
        ...
        assert result == {"code": "test", "name": "Test", "description": ""}
...
class TestBaseConfig:
    ...
    def test_custom_values(self):
        """Test custom values."""
        config = BaseConfig(api_version="v2", kind="Test", metadata=Metadata(code="test"))
    ...
    def test_to_dict(self):
        """Test to_dict method."""
        config = BaseConfig(kind="Agent", metadata=Metadata(code="test", name="Test"))
