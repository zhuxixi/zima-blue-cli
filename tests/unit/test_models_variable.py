...
class TestVariableConfig(TestIsolator):
    ...
    class TestCreate:
        ...
        def test_create_basic(self):
            ...
            var = VariableConfig.create(code="test-vars", name="Test Variables")
        ...
        def test_create_with_all_fields(self):
            ...
            var = VariableConfig.create(
                ...
                values={
                    "task": {"name": "Test Task", "steps": ["step1", "step2"]},
                    "config": {"timeout": 30},
                },
    ...
    class TestValidation:
        ...
        def test_validate_valid(self):
            ...
            var = VariableConfig.create(code="valid-vars", name="Valid Variables")
            errors = var.validate()
            assert errors == []
        ...
        def test_validate_invalid_code_format(self):
            ...
            var = VariableConfig.create(code="Invalid_Code", name="Test")
            errors = var.validate()
        ...
        def test_validate_invalid_for_workflow(self):
            ...
            var = VariableConfig.create(code="test", name="Test", for_workflow="Invalid Workflow")
            errors = var.validate()
    ...
    class TestDictConversion:
        ...
        def test_to_dict(self):
            """Test to_dict method."""
            var = VariableConfig.create(
                code="dict-test", name="Dict Test", for_workflow="wf-code", values={"key": "value"}
            )
        ...
        def test_from_dict(self):
            ...
            data = {
                ...
                "spec": {
                    ...
                    "values": {"task": {"name": "Task"}, "items": ["a", "b"]},
                },
    ...
    class TestValueAccess:
        ...
        def test_get_value_simple(self):
            ...
            var = VariableConfig.create(
                code="test", name="Test", values={"name": "Test", "count": 42}
            )
        ...
        def test_get_value_nested(self):
            ...
            var = VariableConfig.create(
                code="test",
                name="Test",
                values={"task": {"name": "Task Name", "config": {"timeout": 30}}},
            )
        ...
        def test_get_value_nonexistent_path(self):
            ...
            var = VariableConfig.create(code="test", name="Test", values={"task": {"name": "Task"}})
        ...
        def test_has_value(self):
            ...
            var = VariableConfig.create(
                code="test", name="Test", values={"task": {"name": "Task"}, "empty": None}
            )
    ...
    class TestMerge:
        ...
        def test_merge_values(self):
            ...
            var.merge_values({"task": {"status": "done", "priority": "high"}, "new_key": "value"})
        ...
        def test_deep_merge_nested(self):
            ...
            var = VariableConfig.create(
                code="test", name="Test", values={"level1": {"level2": {"a": 1, "b": 2}}}
            )

            var.merge_values({"level1": {"level2": {"b": 20, "c": 30}}})
    ...
    class TestFlatten:
        ...
        def test_flatten_simple(self):
            ...
            var = VariableConfig.create(code="test", name="Test", values={"a": 1, "b": 2})
        ...
        def test_flatten_nested(self):
            ...
            var = VariableConfig.create(
                code="test",
                name="Test",
                values={"task": {"name": "Task", "config": {"timeout": 30}}, "items": ["a", "b"]},
            )
        ...
        def test_list_paths(self):
            ...
            var = VariableConfig.create(
                code="test",
                name="Test",
                values={"task": {"name": "Task"}, "config": {"debug": True}},
            )
    ...
    class TestClear:
        ...
        def test_clear_values(self):
            ...
            var = VariableConfig.create(
                code="test", name="Test", values={"key": "value", "num": 42}
            )
        ...
        def test_clear_updates_timestamp(self):
            ...
            var = VariableConfig.create(code="test", name="Test", values={"key": "value"})
    ...
    class TestWorkflowReference:
        ...
        def test_update_for_workflow(self):
            ...
            var = VariableConfig.create(code="test", name="Test", for_workflow="old-workflow")
            # Set to old timestamp
            var.updated_at = "2026-01-01T00:00:00Z"
            old_updated = var.updated_at
